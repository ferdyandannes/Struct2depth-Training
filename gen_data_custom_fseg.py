...
HEIGHT = 128
STEPSIZE = 1
INPUT_DIR = '/media/ferdyan/NewDisk/Mask/Siap/'
OUTPUT_DIR = '/media/ferdyan/NewDisk/Mask/Siap_procesed/'
...
for d in glob.glob(INPUT_DIR + '/*/'):
    ...
    for d2 in glob.glob(d + '*/'):
        ...
        for subfolder in ['mask']:
            ct = 1
            seqname = d2.split('/')[-2] + subfolder.replace('mask', '')
            seqname2 = seqname[:-4]
            print('')
            print('')
            print('')
